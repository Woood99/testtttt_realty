...
const CreateChar = () => {
   ...
   const onSubmitHandler = data => {
      const resData = { ...data, type: data.type.value, typeId: params.typeId, tab_id: params.attributeId };
      ...
      sendPostRequest(`/admin-api/type/${params.typeId}/create/complex-attribute`, resData).then(res => {
         reset();
         navigate(`${PrivateRoutesPath.types.show}${params.typeId}?attribute=${params.attributeId}`);
      });
   };
         ...
         <div className="main-wrapper--title">
            <div className="container">
               <ElementTitleSubtitle>
                  Создать <span>характеристику жилого комплекса</span>
               </ElementTitleSubtitle>
            </div>
               ...
               <form onSubmit={handleSubmit(onSubmitHandler)}>
                  <div className="white-block">
                     ...
                     <div className="flex items-center gap-6 mt-4">
                        ...
                        <ControllerFieldCheckbox control={control} option={{ label: 'Показывать в фильтре на сайте' }} name="show-filter-on-site" />
                     </div>
                  </div>
