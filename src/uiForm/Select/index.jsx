...
function Select({
   ...
   const variantClasses = {
      selectRoot: variant === 'primary' ? styles.SelectRoot : variant === 'second' ? styles.SelectRootSecond : '',
      selectButton: variant === 'primary' ? styles.SelectButton : variant === 'second' ? styles.SelectButtonSecond : '',
   };
