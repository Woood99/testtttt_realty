...
import RoomInfoApartments from '../RoomInfo/RoomInfoApartments';

const BuildingTabsApartments = memo(() => {
                  ...
                  <>
                     {apartContext.layouts.items.length > 0 ? (
                        apartContext.layouts.items.map((layout, index) => {
                           return (
                              <RoomInfoApartments key={index} data={layout} activeRoomId={activeRoomId} onClick={() => toggleLayout(layout.room)} />
                           );
                        })
                     ) : (
...
export default BuildingTabsApartments;
