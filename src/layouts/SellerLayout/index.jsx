...
import { AuthRoutesPath, RoutesPath, SellerRoutesPath } from "@/constants";

import { capitalizeWords } from "@/helpers";

import { getIsDesktop } from "@/redux";

import { BodyAndSidebar, Header, Sidebar } from "@/components";

import { ElementNavBtn, UserCardSkeleton, UserInfo } from "@/ui";
									...
									<div className="white-block-small !px-0">
										...
										{isDesktop && (
											<div className="mt-6">
												...
												<Link to={RoutesPath.chat} className="w-full">
												...
												<a href={SellerRoutesPath.purchase.list_buyers} className="w-full">
													<ElementNavBtn className="!rounded-none !h-[52px]" active={location.pathname === SellerRoutesPath.purchase.list_buyers}>
														<IconHouseLaptop />
														<span>Мои покупатели</span>
													</ElementNavBtn>
												</a>
												<a href={SellerRoutesPath.purchase.list_all} className="w-full">
													<ElementNavBtn className="!rounded-none !h-[52px]" active={location.pathname === SellerRoutesPath.purchase.list_all}>
														<IconHouseLaptop />
														<span>Все заявки на покупку</span>
													</ElementNavBtn>
												</a>
												<Link to={SellerRoutesPath.calendar_view} className="w-full">
													<ElementNavBtn className="!rounded-none !h-[52px]" active={location.pathname === SellerRoutesPath.calendar_view}>
														<IconHouseLaptop />
														<span>Календарь</span>
													</ElementNavBtn>
												</Link>
												...
												<Link to={SellerRoutesPath.objects_developer} className="w-full">
													<ElementNavBtn className="!rounded-none !h-[52px]" active={location.pathname === SellerRoutesPath.objects_developer}>
														<IconHouseLaptop />
