		...
		<div
			...
			<div className='flex gap-4 items-center md1:items-start'>
				...
				<div className='flex gap-4 items-center flex-grow md1:flex-col md1:items-start'>
					...
					{onClickMessage && (
						<button className=' relative z-30 md1:mt-2 flex gap-2 text-small mmd1:ml-auto' size='Small' onClick={onClickMessage}>
							<IconChat width={16} height={16} className='stroke-blue' />
							<div className='blue-link'>Написать сообщение</div>
						</button>
					)}
					{onClickloginAs && (
