...
export const TagPresent = ({ present = "", title = "Подарок", className }) => {
	return (
		present && (
			<Tag size='small' color='purple' className={className}>
...
export const TagPresents = ({ dataMainGifts = [], dataSecondGifts = [], title = "Подарки", placement = "bottom", className }) => {
	...
	return (
		<Tooltip
			...
			mobile
			color='dark'
			ElementTarget={() => <TagPresent present title={title} className={className} />}>
...
export const TagDiscountSecondary = ({ className, children }) => {
	return <div className={cn(styles.TagDiscountSecondary, className)}>{children}</div>;
};
