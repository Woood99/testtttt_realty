...
import { TagPresents, TagTop, TagsDiscounts, TagsMoreHeight } from "@/ui";
...
const CardPrimaryTagsTop = () => {
	const { cashback, present, top, main_gifts, stickers, second_gifts, buildingDiscounts, buildingCashbacks, apartments } =
